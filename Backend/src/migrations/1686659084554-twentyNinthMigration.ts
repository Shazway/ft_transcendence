...
export class TwentyNinthMigration1686659084554 implements MigrationInterface {
    name = 'TwentyNinthMigration1686659084554'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "match" ("match_id" SERIAL NOT NULL, "current_score" integer array NOT NULL DEFAULT '{0,0}', "match_timer" integer NOT NULL, "round_won" integer array NOT NULL DEFAULT '{0,0}', "is_ongoing" boolean NOT NULL DEFAULT true, "is_ranked" boolean NOT NULL DEFAULT false, "winner" integer NOT NULL DEFAULT '0', "loser" integer NOT NULL DEFAULT '0', "date" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2e7d516f3dc97d9e2f882212d2b" PRIMARY KEY ("match_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "message" ADD CONSTRAINT "FK_641d5701ac78afad27165208d48" FOREIGN KEY ("authorUserId") REFERENCES "user"("user_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
