...
export class EighteenthMigration1685042296866 implements MigrationInterface {
    name = 'EighteenthMigration1685042296866'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "channel" ("channel_id" SERIAL NOT NULL, "channel_name" character varying(20) NOT NULL, "channel_password" character varying(30), "is_channel_private" boolean NOT NULL DEFAULT false, "is_dm" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_161c95ba32beeb8aa68267b54ae" PRIMARY KEY ("channel_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "skin" ("skin_id" SERIAL NOT NULL, "type" character varying NOT NULL, "img_url" character varying, "name" character varying NOT NULL, "price" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_e99a5e8f33a2239976aba778556" PRIMARY KEY ("skin_id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("user_id" SERIAL NOT NULL, "intra_id" integer, "username" character varying(20) NOT NULL, "title" character varying(30), "img_url" character varying(255), "rank_score" integer NOT NULL DEFAULT '0', "currency" integer NOT NULL DEFAULT '100', "activity_status" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "wins" integer NOT NULL DEFAULT '0', "losses" integer NOT NULL DEFAULT '0', "double_auth" boolean NOT NULL DEFAULT false, "current_skins" integer array NOT NULL DEFAULT '{0,1,2}', "inMatch" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_b6b30080359ecd92bb2571c6336" UNIQUE ("intra_id"), CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "PK_758b8ce7c18b9d347461b30228d" PRIMARY KEY ("user_id"))`);
