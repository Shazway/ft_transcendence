...
export class TwentyeighthMigration1686594533037 implements MigrationInterface {
    name = 'TwentyeighthMigration1686594533037'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "match" ("match_id" SERIAL NOT NULL, "current_score" integer array NOT NULL DEFAULT '{0,0}', "match_timer" integer NOT NULL, "round_won" integer array NOT NULL DEFAULT '{0,0}', "is_ongoing" boolean NOT NULL DEFAULT true, "is_ranked" boolean NOT NULL DEFAULT false, "is_victory" boolean array NOT NULL DEFAULT '{false,false}', "date" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2e7d516f3dc97d9e2f882212d2b" PRIMARY KEY ("match_id"))`);
